...
from src.agents.create_agent import create_agent_node
...
def build_graph() -> StateGraph:
    ...
    graph.add_node("create_agent",create_agent_node)
    ...
    graph.add_edge("create_agent", "summary")
